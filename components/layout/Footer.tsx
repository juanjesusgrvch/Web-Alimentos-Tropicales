...
export function Footer() {
  return (
    <footer
      ...
      style={{
        backgroundImage:
          "linear-gradient(180deg, rgb(190, 247, 188) 0%, rgba(232, 255, 207, 1) 40%, rgba(227, 255, 251, 1) 100%)",
      ...
      <div className="container px-4 md:px-6 mx-auto flex flex-col items-center">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 w-full place-items-center mb-12">
          ...
          <div className="col-span-1 flex flex-col items-center text-center">
            <Link
              href="/"
              className="flex items-center justify-center gap-2 font-bold text-xl text-primary mb-4"
            >
              <img
          ...
          <div className="flex flex-col items-center text-center w-full">
            ...
            <div className="flex justify-center space-x-5">
              ...
              <Link
                href="https://www.linkedin.com/in/juan-jesus-perez-gurevich-a0b14b10a/"
                className="text-muted-foreground hover:text-primary transition-colors"
              >
        ...
        <div className="w-full max-w-4xl border-t border-border pt-8 text-center text-sm text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} Alimentos Tropicales Argentinos.
